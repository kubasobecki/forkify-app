...
class AddRecipeView extends View {
  ...
  restoreFormAfterSubmission() {
    const formMarkup = `
      <div class="upload__column">
        <h3 class="upload__heading">Recipe data</h3>
        <label>Title</label>
        <input value="TEST42" required name="title" type="text" />
        <label>URL</label>
        <input value="TEST42" required name="sourceUrl" type="text" />
        <label>Image URL</label>
        <input value="TEST42" required name="image" type="text" />
        <label>Publisher</label>
        <input value="TEST42" required name="publisher" type="text" />
